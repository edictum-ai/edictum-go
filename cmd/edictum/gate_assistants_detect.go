...
const opencodePluginMarker = "// Edictum Gate plugin for OpenCode"
...
func installOpenCode() (string, error) {
	...
	if data, rErr := os.ReadFile(pluginPath); rErr == nil { //nolint:gosec // Known path under ~/.opencode.
		...
		if !strings.Contains(existing, opencodePluginMarker) && !strings.Contains(existing, edictumHookMarker) {
